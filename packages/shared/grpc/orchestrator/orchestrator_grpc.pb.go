...
func (c *sandboxClient) List(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*SandboxListResponse, error) {
...
func (c *sandboxClient) Delete(ctx context.Context, in *SandboxRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedSandboxServer) List(context.Context, *empty.Empty) (*SandboxListResponse, error) {
...
func _Sandbox_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SandboxServer).List(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
